...
1. Move the cursor by **Mouse wheel** or **touchpad** over the cells. Then, click by *mouse button* on your choice.
2. The game has a funny special effect for choosing a cell, winning and losing.
...
---
![A snapshot of the game: TicTacToe, version 0.0.0.0](Media/ver-0-0-0-0.jpg) *Figure 1: A snapshot of TicTacToe Game, version 0.0.0.0, while playing the game.*
---
